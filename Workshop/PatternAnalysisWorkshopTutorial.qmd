...
We choose to compute om a 4 x 4 window. Since the resolution is already coarse (250 m) this will characterize the texture in $1 ~ \mathrm{km}^2$ squares

```{r measures}
stat.list <- c("mean","variance","homogeneity","contrast",
               "entropy","dissimilarity","second_moment",
               "correlation")
glcm.sg <- glcm(sg.utm.raster,
                   window = c(4, 4),
